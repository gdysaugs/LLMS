...
VITE_APP_URL=https://api.lipdiffusion.uk/gradio-ui
...
- The Gradio studio URL is controlled via `VITE_APP_URL` and should point to the worker route
  (`https://api.lipdiffusion.uk/gradio-ui`).
